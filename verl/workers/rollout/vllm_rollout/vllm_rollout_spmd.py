...
class vLLMRollout(BaseRollout):
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        """
        if hasattr(prompts, "meta_info") and "n" in prompts.meta_info:
            self.sampling_params.n = prompts.meta_info["n"]
        else:
            assert "you should set n in meta_info"
        ...
        if "multi_modal_data" in non_tensor_batch:
            ...
            for raw_prompt_ids, multi_modal_data in zip(
                non_tensor_batch.pop("raw_prompt_ids"), non_tensor_batch.pop("multi_modal_data") #有坑
            ):
